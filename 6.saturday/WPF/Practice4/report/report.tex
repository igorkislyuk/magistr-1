...
\begin{document}
	...
	\begin{center}	
		...
		\textbf{Использование компонента BackgroundWorker}\\
...
\screenshot{Пример подсчета циклов первое состояние}{4}
\screenshot{Пример подсчета циклов второе состояние}{5}
