...
\screenshot{Пример создания базового приложения}{9}
\screenshot{Пример создания приложения XBAP}{13}
\screenshot{Пример приложения через WPF Browser Application}{16}
