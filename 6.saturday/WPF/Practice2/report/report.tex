...
\screenshot{Пример вывода информации через AlertController}{3}
\screenshot{Пример формирования интерфейса для форматирования текста}{5}
\screenshot{Пример форматирования текста}{7}
...
Таким образом было задано и построено базовое приложение WPF
