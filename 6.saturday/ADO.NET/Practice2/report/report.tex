...
Изучить работу с LINQ для баз данных.
...
\screenshot{Пример выборки данных по ключевому слову "London"}{2}
\screenshot{Пример выборки заказов одного из покупателей}{7}
